...
public class FlightsController 
{
	...
	public ResponseEntity<List<FlightsDTO>> searchFlights(@PathVariable("currentLocation") String currentLocation, @PathVariable("destination") String destination, @PathVariable("flightDate") LocalDate flightDate, @PathVariable("flightTime") LocalTime flightTime)
	{
	...
	public ResponseEntity<List<FlightsDTO>> searchFlight(@PathVariable("airLinesName") String airLinesName, @PathVariable("flightNumber") int flightNumber, @PathVariable("flightDate") LocalDate flightDate, @PathVariable("flightTime") LocalTime flightTime)
	{
	...
	public ResponseEntity<List<FlightsDTO>> searchFlightsAscending(@PathVariable("flightNumber") int flightNumber, @PathVariable("flightTime") LocalTime flightTime, @PathVariable("flightDate") LocalDate flightDate)
	{
